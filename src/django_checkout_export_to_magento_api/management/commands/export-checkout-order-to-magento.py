...
class Command(BaseCommand):
    help = "Export Checkout Order to Magento2"
    ...
    def handle(self, *args, **options):
        ...
        if len(order_id_raw) == 10:
            ...
            raise ValueError("Order id is invalid, use order_pretty_id (10 chars) or order_id (36 chars)")
        export_checkout_order_to_magento(channel_idx=channel_idx, order_id=order_id, order_pretty_id=order_pretty_id)
